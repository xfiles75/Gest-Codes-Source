...
<div class='container'>
   <div class='image-container'>
    <img src='img/delphi2.jpg'> 
   </div>
 	
<h1 text-align:center>GESTION DES CODES SOURCE : ORACLE-DELPHI  </h1>
...
$titre = "Table Opérations";

echo "<h3 class='espace-mots'>$titre</h3>";
//echo 'Table';
 
//echo 'Opérations';
//echo '<br>';
echo '<select name="table" class="combobox">';
...
echo '<button  id="mon-bouton" name="nouveau" class="button">Bouton Nouveau</button>';
echo '<button  name="enregistrer" class="button">Bouton Enregistrer</button>';
echo '<button  name="modifier" class="button">Bouton Modifier</button>';
echo '<button  name="supprimer" class="button">Bouton Supprimer</button>';
echo '<button  name="actualiser" class="button">Bouton Actualiser</button>';
echo '<button  name="annuler" class="button">Bouton Annuler</button>';
